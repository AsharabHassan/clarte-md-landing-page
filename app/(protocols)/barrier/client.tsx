...
export default function BarrierClient() {
  ...
  const PROGRESS_STEPS = [
    { pct: 8,  msg: 'Reading redness, hydration, and barrier markers…' },
    { pct: 20, msg: 'Mapping reactivity and dryness zones…' },
    { pct: 34, msg: 'Modelling ceramide and HA barrier response…' },
    { pct: 48, msg: 'Projecting twelve-week barrier repair…' },
    { pct: 62, msg: 'Reconstructing calmer redness and hydration…' },
  ...
  async function startGeneration() {
    ...
    try {
      ...
      await openLeadGate({ surface: 'barrier', concern: 'barrier', ai_session_id: lastAiSessionId || undefined, skin_map: lastSkinMap || undefined });
